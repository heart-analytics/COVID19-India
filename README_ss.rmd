...
The code of the  analysis is in the R Markdown source file [README.rmd](README.rmd). Draft of paper is in [COVID19-India.pdf](COVID19-India.pdf). Data is in folder [Data](/Data/). We obtained the data from [www.covid19india.org](https://www.covid19india.org/).
