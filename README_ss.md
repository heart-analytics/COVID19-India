...
The code of the analysis is in the R Markdown source file
...
![](README_ss_files/figure-gfm/Figure%201%20(a)-1.png)<!-- -->
...
![](README_ss_files/figure-gfm/Figure%202(a)-1.png)<!-- -->

**Figure 2(b) portrays the same for the second wave.**
![](README_ss_files/figure-gfm/Figure%202(b)-1.png)<!-- -->
