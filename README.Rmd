...
The code of the analysis presented here in the R Markdown source file [README.rmd](/README.rmd). Draft of paper is in [COVID19-India.pdf](COVID19-India.pdf). Data is in folder [Data](/Data). We obtained the data from [www.covid19india.org](https://www.covid19india.org/).
...
if(if_run_regression_or_read_figure){
  ...
  include_graphics("README_figs_bkp/README-unnamed-chunk-26-1.png")
}
```
