...
The code of the analysis presented here in the R Markdown source file [README.Rmd](/README.Rmd). Draft of paper is in [COVID19-India.pdf](/COVID19-India.pdf). The data is in [Data](/Data) folder. We obtained the data from [www.covid19india.org](https://www.covid19india.org/).
