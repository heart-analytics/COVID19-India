...
[README.Rmd](blob/main/README.Rmd). Draft of paper is in
[COVID19-India.pdf](blob/main/COVID19-India.pdf). The data is in
[Data](tree/main/Data) folder. We obtained the data from
